...
# Importante usar os mesmos dados dados em algoritmos diferentes ! Caso o contrario nao eh confiavel comparar.
...
# tudo um unico valor
acerto_base = max(Counter(validacao_marcacoes).itervalues())  # Python 3 -> '.values' ao inves de '.itervalues'
